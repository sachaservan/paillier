...
func TestCombineSharesConstant(t *testing.T) {
	...
	if c := tk.CombineSharesConstant(); !reflect.DeepEqual(b(4558), c) {
...
func TestUpdateLambda(t *testing.T) {
	tk := new(ThresholdKey)
	lambda := b(11)
	share1 := &PartialDecryption{3, b(5), 0}
	share2 := &PartialDecryption{7, b(3), 0}
...
func TestupdateCprime(t *testing.T) {
	...
	cprime := b(77)
	lambda := b(52)
	share := &PartialDecryption{3, b(5), 0}
...
func TestDecryption(t *testing.T) {
	...
	share1 := &PartialDecryption{1, b(384111638639), 0}
	share2 := &PartialDecryption{2, b(235243761043), 0}
	tk := new(ThresholdKey)
	tk.Threshold = 2
...
func TestValidate(t *testing.T) {
	...
	if err := pk.Verify(rand.Reader); err != nil {
		t.Error(err)
	}
	pk.Id++
	if err := pk.Verify(rand.Reader); err == nil {
...
func TestVerifyDecryption(t *testing.T) {
	...
	if err = pk.VerifyDecryption(cipher, b(101), pds); err != nil {
		t.Error(err)
	}
	if err = pk.VerifyDecryption(cipher, b(100), pds); err == nil {
		t.Error(err)
	}
